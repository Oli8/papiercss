...
Production builds use `base: /papiercss/` for GitHub Pages. Copy `docs/dist` into the `/papiercss` folder of the Pages site. Hash routing is used so refreshes work without a root `404.html`.
